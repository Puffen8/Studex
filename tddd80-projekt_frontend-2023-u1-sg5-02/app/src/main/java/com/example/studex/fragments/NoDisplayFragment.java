...
public class NoDisplayFragment extends Fragment {
    public NoDisplayFragment() {
    ...
    public static NoDisplayFragment newInstance() {
        NoDisplayFragment fragment = new NoDisplayFragment();
        return fragment;
    }
